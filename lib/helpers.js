...
const sendlinks = (senderEmail, password, recipient, subject, pollQuestion, adminLink, userLink) => {
  ...
  const mail = {
    ...
    to: recipient,
    subject: subject,
    text: `Poll question: ${pollQuestion}\nShare with your friends: http://localhost:8080/${userLink}\nCheck the results: http://localhost:8080/my/${adminLink}`
  };
...
module.exports = { urlCreator, sendlinks, createQueries, createValues, validateText, generateWeightings };
